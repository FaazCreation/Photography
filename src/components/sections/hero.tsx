  ...
  return (
    <section className="relative h-[70vh] md:h-[90vh] w-full flex items-center justify-center text-center text-white">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4">
        <h1 className="text-2xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight drop-shadow-lg animate-fade-in-down leading-tight">
          Tejgaon College Photography Club
        </h1>
        <p className="mt-4 text-base md:text-xl text-slate-200 max-w-3xl mx-auto drop-shadow animate-fade-in-up [animation-delay:0.2s]">
